...
import { FormControl, InputLabel, MenuItem, Toolbar, Select, SelectChangeEvent, FormGroup, FormControlLabel, Checkbox, Grid } from '@mui/material';
  ...
  return (
    <Toolbar sx={{justifyContent: 'center'}}>
       <Grid container
        ...
        <FormGroup>
          <FormControlLabel control={<Checkbox value={recordCheckbox} onChange={handleCheckboxChange}/>} label='Incluir Histórico' />
        </FormGroup>
        <LoadingButton
          onClick={handleClick}
